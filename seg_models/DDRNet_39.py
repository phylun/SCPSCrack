...
def DualResNet_imagenet():
    model = DualResNet(BasicBlock, [3, 4, 6, 3], num_classes=2, planes=64, spp_planes=128, head_planes=256, augment=False)
...
if __name__ == '__main__':
    ...
    model =DualResNet_imagenet().cuda(0)
    model.eval()
    out = model(img)
    print(out.size())

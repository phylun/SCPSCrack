...
from seg_models.layers import ConvModule
from seg_models.modules import PPM
...
class UPerHead(nn.Module):
    ...
    def __init__(self, in_channels, channel=128, num_classes: int = 19, scales=[2, 4, 6, 12]):
        super().__init__()
        # PPM Module
